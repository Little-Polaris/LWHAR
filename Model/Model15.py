...
class st_attention_block(nn.Module):
    def __init__(self, in_channels, out_channels, rel_reduction=8):
        ...
        self.W_K = nn.Conv2d(in_channels, out_channels//2, kernel_size=1)
        self.W_Q = nn.Conv2d(in_channels, out_channels//2, kernel_size=1)
        self.W_V = nn.Conv2d(in_channels, out_channels, kernel_size=1)
        self.attention = attention(out_channels//2, out_channels//2)
